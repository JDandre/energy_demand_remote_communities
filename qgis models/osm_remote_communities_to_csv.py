...
class AddParametersToCommunities(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterFile('OSMfileinput', 'OSM file input', behavior=QgsProcessingParameterFile.File, fileFilter='.osm', defaultValue='C:\\Users\\Jaret\\Documents\\GitHub\\AI-Launch-Lab-remote-communities-renergentic\\data\\raw\\osm files\\arviat_com.osm'))
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        alg_params = {
            'FILE': parameters['OSMfileinput'],
            'OSM_CONF': ''
        }
        outputs['OpenSublayersFromAnOsmFile'] = processing.run('quickosm:openosmfile', alg_params, context=context, feedback=feedback, is_child_algorithm=True)
        ...
        alg_params = {
            'FIELDS_MAPPING': [
            {'expression': '"osm_way_id"','length': 254,'name': 'osm_id','precision': 0,'type': 10},
        ...
        outputs['RefactorFieldsosm'] = processing.run('native:refactorfields', alg_params, context=context, feedback=feedback, is_child_algorithm=True)
        ...
        alg_params = {
            ...
            'LAYERS': outputs['RefactorFieldsosm']['OUTPUT'],
            'OVERWRITE': False,
            'USE_ALIAS': True,
